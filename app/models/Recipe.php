...
class Recipe extends Eloquent {
    ...
    */
    ...
    /**
    * Search among recipes, authors and tags
    * @return Collection
    */
    public static function search($query) {
        ...
        # Otherwise, just fetch all recipes
        else {
            # Eager load tags and author
    ...
    /**
    * Searches and returns any recipes added in the last 24 hours
    *
    * @return Collection
    */
    public static function getRecipesAddedInTheLast24Hours() {
        ...
        $recipes = Recipe::where('created_at','>',$past_24_hours)->get();
    ...
    * @return String
    */
    public static function sendDigests($users,$recipes) {
